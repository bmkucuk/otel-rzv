...
# ── Kullanıcılar ──────────────────────────────────────────────────────────────
USERS = {
    'admin':   {'hash': 'c7e9988d0ac79f466bf33b7bc5a8e31ebad2fe1f6e17c78919f5717acce44230', 'role': 'admin'},
    'misafir': {'hash': '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'role': 'personel'},
}
...
def api_rez_yeni():
    try:
        ...
        yevmiye_rez_kaydet(
            ...
            data.get('otel', 'GENEL'), data.get('giris'),
            data.get('musteri', ''),
